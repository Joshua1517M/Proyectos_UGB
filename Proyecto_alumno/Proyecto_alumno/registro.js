Vue.component('registro', {
    ...
    created() {
        db_sistema.transaction(tx => {
            tx.executeSql('CREATE TABLE IF NOT EXISTS alumnos(idAlumno INTEGER PRIMARY KEY AUTOINCREMENT, nombres char(100), apellidos char(100),fecha date, sexo char(30), codigo char(10), telefono TEXT, direccion TEXT, correo TEXT, carrera TEXT)');
        }, err => {
            console.log(err);
        });
        this.obtenerAlumnos();
